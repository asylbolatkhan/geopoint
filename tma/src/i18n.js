export const T = {
  kk: {
    ...
    modeCapSetupNote: 'Әр режим (баптаулар жиынтығы) күніне 2 рет қана ұпай әкеледі — режимдерді ауыстырып ойна',
    modeCapPlayNote: 'Бұл режимді бүгін 2 рет ойнадың — бұл ойыннан ұпай берілмейді. Басқа режим таңдасаң, ұпай қайта беріледі',
    modeCapResultNote: 'Ұпай берілмеді: бір режим күніне тек 2 рет ұпай әкеледі. Бұл — жеңіл режимді қайталап ұпай жинамас үшін. Басқа режимді сынап көр 😉',
  ...
  ru: {
    ...
    modeCapSetupNote: 'Каждый режим (набор настроек) даёт очки только 2 раза в день — меняй режимы',
    modeCapPlayNote: 'Ты уже сыграл этот режим 2 раза сегодня — очки за эту игру не начислятся. Выбери другой режим, чтобы снова получать очки',
    modeCapResultNote: 'Очки не начислены: один режим даёт очки только 2 раза в день. Это чтобы нельзя было набирать очки, повторяя лёгкий режим. Попробуй другой режим 😉',
